        ...
        <TooltipContent side="bottom" align="end" sideOffset={8} collisionPadding={8} arrowClassName="!bg-popover !fill-popover" className="w-64 max-w-[calc(100vw-1rem)] rounded-xl border border-border/60 bg-popover p-3 text-popover-foreground shadow-xl">
          <div className="space-y-2">
            ...
            {pressure.known ? <>
              ...
              {pressure.overflow ? <p className="text-[10px] leading-snug text-red-400">Reported usage exceeds this model&apos;s known maximum.</p> : pressure.compactRecommended ? <p className="text-[10px] leading-snug text-muted-foreground">J.A.R.V.I.S. can compact managed history before the next run when context pressure is high.</p> : null}
            </> : null}
