...
#   irm https://raw.githubusercontent.com/TheGalitube/Jarvis-Mk3.1/master/install.ps1 | iex
...
$base = if ($env:METIS_AI_INSTALL_BASE) { $env:METIS_AI_INSTALL_BASE.TrimEnd("/") } else { "https://raw.githubusercontent.com/TheGalitube/Jarvis-Mk3.1/master" }
$forward = @()
