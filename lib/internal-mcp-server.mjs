...
const server = new Server(
  { name: `${process.env.APP_NAME?.trim() || "J.A.R.V.I.S. Mk3.1"} internal MCP`, version: "1.0.0" },
  {
    capabilities: { tools: {} },
    instructions:
      `This is the built-in MCP server for ${process.env.APP_NAME?.trim() || "J.A.R.V.I.S. Mk3.1"}. It exposes the configured local gateway tool catalog.`,
  },
);
